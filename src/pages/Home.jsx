    ...
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="py-14 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p className="mb-8 flex flex-col items-center text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
          ...
          <p onClick={()=>window.location="https://github.com/MohammadV2704"} className="cursor-pointer text-cyan-700 flex gap-2 items-center hover:underline ">
        ...
        <div className="flex justify-center">
          <img
            className="blue_hexagonal.png"
            style={{ filter: "drop-shadow(0px 20px 120px white)" }}
